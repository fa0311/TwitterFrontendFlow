...
print(TwitterFrontendFlow().login_flow().LoginJsInstrumentationSubtask().LoginEnterUserIdentifierSSOSubtask("faa0311").AccountDuplicationCheck().LoginEnterPassword("").LoginTwoFactorAuthChallenge("340908").content)
